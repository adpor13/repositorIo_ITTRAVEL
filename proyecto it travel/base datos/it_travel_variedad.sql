...
CREATE TABLE `variedad` (
  ...
  `id_modalidad_var` varchar(20) NOT NULL,
  PRIMARY KEY (`id_variedad`,`id_modalidad_var`),
  KEY `fk_vairedad_modalidad1_idx` (`id_modalidad_var`),
  CONSTRAINT `fk_vairedad_modalidad1` FOREIGN KEY (`id_modalidad_var`) REFERENCES `modalidad` (`id_modalidad`) ON DELETE NO ACTION ON UPDATE NO ACTION
